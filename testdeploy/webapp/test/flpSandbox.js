		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapdemotestdeploy-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapdemotestdeploy-display": {
								"semanticObject": "sapdemotestdeploy",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.demo.testdeploy",
									"url": sap.ui.require.toUrl("sap/demo/testdeploy")
								}
							}
						}
					}
