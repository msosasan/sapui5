		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices2",
									"targetURL": "#tsystemsinvoices2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tsystemsinvoices2-display": {
								"semanticObject": "tsystemsinvoices2",
								"action": "display",
								"description": "Test fior free style app",
								"title": "Invoices2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tsystems.invoices2",
									"url": sap.ui.require.toUrl("tsystems/invoices2")
								}
							}
						}
					}
