		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product List",
									"targetURL": "#tsystemsproducts-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tsystemsproducts-display": {
								"semanticObject": "tsystemsproducts",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tsystems.products",
									"url": sap.ui.require.toUrl("tsystems/products")
								}
							}
						}
					}
