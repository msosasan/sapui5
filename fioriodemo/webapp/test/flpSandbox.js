			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"HelloApp-display": {
								"semanticObject": "HelloApp",
								"action": "display",
								"description": "First SAP UI5 app",
								"title": "Hello App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tsystems.fioriodemo",
									"url": sap.ui.require.toUrl("com/tsystems/fioriodemo")
								}
							}
						}
					}
